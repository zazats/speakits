...
// Displayes the image generated by the Blockadale API
// this function is triggered by the Pusher callback once Blockadale service is 
// publishing the requesr status via the Pusher channel

 export const loadVenueEvent = async function loadVenueEvent(eventData) {
