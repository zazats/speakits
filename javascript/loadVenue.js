...
const myHeaders = new Headers();
 ...
 window.loadVenueEvent = async function loadVenueEvent(eventData) {
  ...
  //  };
   ...
   //const response2 = await fetch(`https://backend.blockadelabs.com/api/v1/imagine/requests/${data.id}`, requestOptions);
   //const response2 = await fetch("https://backend.blockadelabs.com/api/v1/imagine/requests/10553724", requestOptions);
